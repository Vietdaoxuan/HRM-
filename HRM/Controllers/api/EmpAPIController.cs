...
namespace HRM.Controllers
{
    ...
    {
        private SqlParameter[] callParamsFromEmp(Employee employee, string id,string action = null,string tblName = null)
        {
            DataAccessLayer act = new DataAccessLayer();
            if (action == "Insert")
            {
                //employee.EmpID = act.getOutPut("sp_AutoGenID_Emp_Test", "@EmpID");
                SqlParameter[] prmsOut =
                {
                    new SqlParameter("@EmpID",SqlDbType.NVarChar,12){ Value = employee.EmpID ?? (object)DBNull.Value}
                };
                prmsOut[0].Direction = ParameterDirection.Output;
                DataSet dsOut = act.Generic("sp_AutoGenID_Emp_Test", prmsOut);
                string empid = prmsOut[0].Value.ToString();
        ...
        {
            DataAccessLayer act = new DataAccessLayer();
            DataSet ds = act.Generic("sp_InsertUpdateDelete_tblEmpCV", callParamsFromEmp(employee,null,"Insert", "EmpCV"));
            DataSet ds1 = act.Generic("sp_InsertUpdateDelete_tblEmp", callParamsFromEmp(employee,null,"Insert", "Emp"));
            return Ok();
        }
        ...
        {
            DataAccessLayer act = new DataAccessLayer();
            DataSet ds = act.Generic("sp_InsertUpdateDelete_tblEmpCV", callParamsFromEmp(employee,id,"Update","EmpCV"));
            DataSet ds1 = act.Generic("sp_InsertUpdateDelete_tblEmp", callParamsFromEmp(employee,id,"Update","Emp"));
            return Ok();
        }
